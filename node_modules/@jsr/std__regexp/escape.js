...
const ESCAPE_REGEXP = new RegExp(`[${Object.values(RESERVED_CHARS).join("")}]`, "gu");
/**
 ...
 */ export function escape(str) {
  return str.replaceAll(ESCAPE_REGEXP, (m)=>RESERVED_CHARS[m]).replace(/^[0-9a-zA-Z]/, (m)=>`\\x${m.codePointAt(0).toString(16)}`);
}

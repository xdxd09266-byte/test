 ...
 */ function setDefaultValues(ctx, opts) {
  ...
  for (const option of opts.flags){
    ...
    const hasDefaultValue = (!opts.ignoreDefaults || typeof opts.ignoreDefaults[name] === "undefined") && typeof ctx.flags[name] === "undefined" && (typeof option.default !== "undefined" || option.args?.some((arg)=>arg.default !== undefined) || typeof defaultValue !== "undefined");
    if (hasDefaultValue) {
...
//# sourceMappingURL=_validate_flags.js.map
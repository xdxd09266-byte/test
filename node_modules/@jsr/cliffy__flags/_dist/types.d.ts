/** Parser options. */ export interface ParseFlagsOptions<TFlagOptions extends FlagOptions = FlagOptions> {
  /** An array of flag options. */ flags?: Array<TFlagOptions>;
  args?: Array<ArgumentOptions>;
  /** Parser callback function for custom types. */ parse?: TypeHandler<unknown>;
  /** Option callback function. Will be called for all parsed options. */ option?: (option: TFlagOptions, value?: unknown) => void;
  /**
   ...
   */ stopEarly?: boolean;
  /** Works similar to `stopEarly`, bit stops on first unknown option or argument. */ stopOnUnknown?: boolean;
  /**
   * Don't throw an error when no arguments are passed to the `parseFlags`
   * function.
   */ allowEmpty?: boolean;
  /** Ignore default values for defined flags. */ ignoreDefaults?: Record<string, unknown>;
  /** Enable/disable dotted options. Default is `true`. */ dotted?: boolean;
}
/** Flag options. */ export interface FlagOptions extends Omit<ArgumentOptions, "optional" | "value"> {
  /** The name of the flag. */ name: string;
  /** An array of argument options. */ args?: Array<ArgumentOptions>;
  /** Mark argument as optional. */ optionalValue?: boolean;
  /** Name aliases. */ aliases?: string[];
  /** If enabled, option cannot be combined with other options. */ standalone?: boolean;
  /** Default value. */ default?: DefaultValue;
  /** Mark flag as required. */ required?: boolean;
  /**
...
/** Options for a flag argument. */ export interface ArgumentOptions {
  /** An optional name for the argument. */ name?: string;
  /** Argument type. */ type?: ArgumentType | string;
  /** Make argument optional. */ optional?: boolean;
  /** Make argument variadic. */ variadic?: boolean;
  /**
...
/** A callback method for custom processing or mapping of flag values. */ export type ValueHandler<TValue = any, TReturn = TValue> = (val: TValue, previous?: TReturn) => TReturn;
/**
 ...
 */ export interface ParseFlagsContext<TFlags extends Record<string, any> = Record<string, any>, TStandaloneOption extends FlagOptions = FlagOptions> {
  /** An object of parsed flags. */ flags: TFlags;
  /** An array of parsed arguments. */ args?: Array<unknown>;
  /** An array of unknown arguments. */ unknown: Array<string>;
  /** An array of arguments defined after the double dash ` -- `. */ literal: Array<string>;
  /** Matched standalone option. */ standalone?: TStandaloneOption;
  /** Is set to `true` if `stopEarly` option is enabled. */ stopEarly: boolean;
  /** Is set to `true` if `stopOnUnknown` option is enabled. */ stopOnUnknown: boolean;
  /** A map of option names and default values. */ defaults: Record<string, boolean>;
  /**
...
/** Argument parsing informations. */ export interface ArgumentValue {
  /** A label/name which describes the kind of argument, e.g: `Option`. */ label: string;
  /** The type of the argument. */ type: ArgumentType | string;
  /** The name of the argument. */ name: string;
  /** The value of the argument. */ value: string;
}
/**

...
class Printf {
    ...
    for(; this.i < this.format.length; ++this.i){
      ...
      switch(this.state){
        ...
        case State.PERCENT:
          ...
          break;
        default:
          throw new Error(`State ${this.state} should be unreachable, please file a bug report against Deno at https://github.com/denoland/std/issues`);
      }
    }
  ...
  /** Handle positional */ handlePositional() {
    if (this.format[this.i] !== "[") {
      // sanity only
      throw new Error("Should be unreachable, please file a bug report against Deno at https://github.com/denoland/std/issues");
    }
    let positional = 0;
   ...
   */ fmtHex(val, upper = false) {
    ...
    switch(typeof val){
      ...
      default:
        throw new Error(`Cannot format hex, only number and string are supported for hex formatting: ${typeof val} is given`);
    }
  }
  /**
   * Format value

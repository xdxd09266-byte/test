...
/** Regex `source` to match any relevant ANSI code. */ export const ansiRegexSource = // deno-lint-ignore no-control-regex
 ...
 */ export function getUnclosedAnsiRuns(text) {
  ...
  return {
    /** The suffix to be appended to the text to close all unclosed runs. */ currentSuffix,
    /**

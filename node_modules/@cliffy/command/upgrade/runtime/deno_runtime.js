...
/** Deno runtime upgrade handler. */ export class DenoRuntime extends Runtime {
  ...
  async execute(cmdArgs, logger) {
    logger?.log(dim("$ %s %s"), Deno.execPath(), cmdArgs.join(" "));
...
//# sourceMappingURL=deno_runtime.js.map
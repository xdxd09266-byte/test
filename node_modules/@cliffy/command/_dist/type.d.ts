...
import type { ArgumentValue, CompleteHandlerResult, TypeOrTypeHandler, ValuesHandlerResult } from "./types.js";
/**
...
export declare namespace Type {
  /** @deprecated Use `InferType` instead. */ export type infer<TType, TDefault = TType> = InferType<TType, TDefault>;
}
export type InferType<TType, TDefault = TType> = TType extends TypeOrTypeHandler<infer Value> ? Value : TDefault;

...
/** Fish completions generator. */ export class FishCompletionsGenerator {
  name;
  cmd;
  /** Generates fish completions script for given command. */ static generate(name, cmd) {
...
${this.generateCompletions(this.name, this.cmd).trim()}`;
  ...
  getCompletionCommand(cmd, arg) {
    ...
    return `'(${this.name} completions complete ${arg.action + " " + getCompletionsPath(cmd)} 2>/dev/null)'`;
  }
}
...
//# sourceMappingURL=_fish_completions_generator.js.map
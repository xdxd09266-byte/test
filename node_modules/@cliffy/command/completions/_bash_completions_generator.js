...
/** Generates bash completions script. */ export class BashCompletionsGenerator {
  name;
  cmd;
  /** Generates bash completions script for given command. */ static generate(name, cmd) {
...
complete -F _${replaceSpecialChars(path)} -o bashdefault -o default ${path}`;
  ...
  /** Generates bash completions method for given command and child commands. */ generateCompletions(name, command, path = "", index = 1) {
    path = (path ? path + " " : "") + name;
...
//# sourceMappingURL=_bash_completions_generator.js.map
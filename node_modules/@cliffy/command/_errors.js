...
export class MissingCommandNameCompletionsError extends CommandError {
  constructor(shell){
    super(`Failed to generate shell completions. Missing main command name. Use '${bold('cmd.name("<command-name>")')}' to set the name of the main command or use the '${bold("--name")}' option from the '${bold("completions")}' command to set the cli name: '${bold(`<command> completions ${shell} --name <cli-name>`)}'.`);
